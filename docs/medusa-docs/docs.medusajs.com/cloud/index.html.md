...
Refer to the [Sign Up for Cloud](https://docs.medusajs.com/sign-up) guide to get started.
...
- **Medusa Cache**: Benefit from performance improvements of business-critical APIs by reducing heavy operations to the database. [Medusa Cache](https://docs.medusajs.com/cache) is available out of the box at no additional cost.
