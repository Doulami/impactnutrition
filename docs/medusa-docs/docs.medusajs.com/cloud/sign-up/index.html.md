...
If you already have a Cloud account and you want to create a new organization, refer to the [Create an Organization](https://docs.medusajs.com/organizations#create-or-join-an-organization) guide instead.
...
- **What should we call you?**: Enter your full name.
  - This name will be used as the organization's name. You can change the organization name later in the [organization settings](https://docs.medusajs.com/organizations#edit-organization-details).
...
Learn about the different plans and their features in the [Plans guide](https://docs.medusajs.com/pricing).
...
Once you finish the sign-up, you will be charged upfront for the first month based on the plan you selected. You can learn more about this in the [Billing guide](https://docs.medusajs.com/billing).
...
- [Create projects](https://docs.medusajs.com/projects) to deploy your Medusa applications.
- [Manage your organization](https://docs.medusajs.com/organizations) settings, including inviting team members.
- [Change your plan](https://docs.medusajs.com/billing#change-your-organizations-plan) or update your payment details.
