...
Learn more about API routes [in this guide](https://docs.medusajs.com/learn/fundamentals/api-routes).
...
Learn more about API route validation in [this chapter](https://docs.medusajs.com/learn/fundamentals/api-routes/validation).
...
Learn more about middlewares in [this chapter](https://docs.medusajs.com/learn/fundamentals/api-routes/middlewares).
