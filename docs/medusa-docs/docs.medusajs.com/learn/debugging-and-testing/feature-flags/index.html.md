...
For example, to enable the [Index Module](https://docs.medusajs.com/learn/fundamentals/module-links/index-module)'s feature flag in `medusa-config.ts`:
...
Make sure to [run migrations](https://docs.medusajs.com/learn/fundamentals/data-models/write-migration#run-the-migration) after enabling a feature flag, in case it requires database changes.

Before disabling a feature flag, make sure to [roll back the migrations](https://docs.medusajs.com/learn/fundamentals/data-models/write-migration#rollback-the-migration) that depend on it.
...
For example, to enable the [Index Module](https://docs.medusajs.com/learn/fundamentals/module-links/index-module)'s feature flag using an environment variable:
...
For example, to enable access to a route only if a feature flag is enabled, you can use the `FeatureFlag` utility in a [middleware](https://docs.medusajs.com/learn/fundamentals/api-routes/middlewares):
...
For example, you can show an [admin widget](https://docs.medusajs.com/learn/fundamentals/admin/widgets) only if a feature flag is enabled:
