...
The Medusa Admin dashboard supports [multiple languages](https://docs.medusajs.com/user-guide/tips/languages) for its interface. Medusa uses [react-i18next](https://react.i18next.com/) to manage translations in the admin dashboard.

Medusa Admin translations apply to the interface only. Medusa doesn't support translating store content, such as product names or descriptions. To implement localization for store content, [integrate a CMS](https://docs.medusajs.com/resources/integrations#cms).

When you create [Widgets](https://docs.medusajs.com/learn/fundamentals/admin/widgets) or [UI Routes](https://docs.medusajs.com/learn/fundamentals/admin/ui-routes) to customize the Medusa Admin, you can provide translations for the text content in your customizations, allowing users to view your customizations in their preferred language.
...
Next, [change the admin language](https://docs.medusajs.com/user-guide/settings/profile#edit-profile-details) to Spanish. The widget will now display the text in Spanish.
