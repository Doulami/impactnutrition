...
You can use these workflows and steps in your customizations. For example, you can [execute these workflows](https://docs.medusajs.com/learn/fundamentals/workflows#3-execute-the-workflow):

- In an [API route](https://docs.medusajs.com/learn/fundamentals/api-routes) when a request is received;
- In a [subscriber](https://docs.medusajs.com/learn/fundamentals/events-and-subscribers) when an event is emitted;
- In a [scheduled jobs](https://docs.medusajs.com/learn/fundamentals/scheduled-jobs) at a specified interval during the application's runtime;
- In a [custom CLI scripts](https://docs.medusajs.com/learn/fundamentals/custom-cli-scripts) that you can execute from the terminal;
