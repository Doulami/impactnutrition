...
For other information related to the Medusa application's installation, refer to [this documentation](https://docs.medusajs.com/learn/installation).
...
- [Stripe Module Provider installed in the Medusa application.](../commerce-modules/payment/payment-provider/stripe/page.mdx)
...
Refer to [this guide](https://docs.medusajs.com/nextjs-starter/guides/customize-stripe) to learn how to customize the Stripe integration and components.
