...
Learn more about the data model repository in the [Database Operations](https://docs.medusajs.com/learn/fundamentals/modules/db-operations) documentation.

## When to Use the Data Model Repository?

If your module has data models, then you should always extend the [service factory](https://docs.medusajs.com/learn/fundamentals/modules/service-factory). It generates basic data-management operations for your module's data models.
