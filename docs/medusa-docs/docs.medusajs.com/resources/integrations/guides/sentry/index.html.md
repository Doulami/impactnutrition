...
Refer to the [Instrumentation](https://docs.medusajs.com/learn/debugging-and-testing/instrumentation) documentation for more details on how to set up instrumentation in Medusa.
...
Refer to the [Throwing and Handling Errors](https://docs.medusajs.com/learn/fundamentals/api-routes/errors) guide to learn more about Medusa's default error handling behavior.
