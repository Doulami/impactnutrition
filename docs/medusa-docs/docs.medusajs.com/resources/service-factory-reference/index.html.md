...
Refer to the [Service Factory](https://docs.medusajs.com/learn/fundamentals/modules/service-factory) documentation to learn more.
...
The internal services are useful when you need to perform database operations in loaders, as they're executed before the module's services are registered. Learn more in the [Module Container](https://docs.medusajs.com/learn/fundamentals/modules/container) documentation.
